...
The plugin owns the local daemon message flow and delivers notifications through the regular OpenClaw `comment-io` channel. Do not start an extra CLI wait loop from OpenClaw, and do not create a background polling task for this skill.
