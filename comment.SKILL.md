...
description: >-
  ...
  and secrets. Fetch https://comment.io/llms.txt for the current API, local sync, identity,
...
Save doc URLs and tokens the user gives you. Do not rely on this file for endpoint details, local sync behavior, recovery, or local-file safety; the canonical docs live at https://comment.io/llms.txt.